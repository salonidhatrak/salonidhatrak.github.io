    ...
    return(
        ...
        <Box pb={{base : '20px', md : '30px'}}>
            ...
            <Flex w={{base :'60%', md : '35%', lg : '25%'}} m='auto' justifyContent='space-around' fontSize={{base : '22px', md : '26px', lg :'30px'}} mt='20px'>
                <Box>
                 <a href="https://www.linkedin.com/in/saloni-dhatrak-34201b229/" target='_blank'> <Text><BsLinkedin/></Text></a>
                </Box>

                <Box>
                   <a href="https://github.com/salonidhatrak" target='_blank'><Text><BsGithub/></Text></a>
                </Box>
